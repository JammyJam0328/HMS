                    ...
                    <div class="mt-6 bg-gray-200 bg-opacity-20">
                        <form method="POST" action="{{ route('login') }}" class="space-y-6">
                            ...
                            <div class="bg-white pt-3 px-2 rounded-md">
                                <div class="relative z-0 mb-6  w-full group">
                                    <input id="email" type="email" name="email" :value="old('email')" required autofocus name="floating_email" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0  border-gray-300 appearance-none dark:text-white  dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                                    <label for="floating_email" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-gray-700  peer-focus:font-bold peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Email Address</label>
                                </div>
                            </div>
                            <div class="bg-white pt-3 px-2 rounded-md">
                                <div class="relative z-0 mb-6  w-full group">
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <label for="remember-me" class="ml-2 block text-sm text-gray-700"> Remember me
                                    </label>
                                </div>
                            ...
                            <div>
                                <button type="submit"
                                    class="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-bold text-white bg-gray-600 hover:bg-gray-700 focus:outline-none focus:ring-2 uppercase focus:ring-offset-2 focus:ring-gray-500">Login</button>
                            </div>
                           
                        </form>
                        <a class="underline mt-5 text-sm text-gray-700 hover:text-gray-900" href="{{ route('register') }}">
                        ...
                        <div class="mt-6 relative">
                            ...
                            <div class="relative flex justify-center text-sm">
                                <span class="px-2 bg-gray-200 text-gray-700"> Or continue with </span>
                            </div>
                        </div>
