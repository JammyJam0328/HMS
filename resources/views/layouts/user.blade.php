...
<body x-data="{mobileNavOpen:false}"
    class="h-full antialiased font-poppins bg-mainback">
...
<div class="">
      ...
      <div class="relative bg-gray-700">
        <div class="flex justify-between items-center max-w-7xl mx-auto px-4 py-3 sm:px-6 md:justify-start md:space-x-10 lg:px-8">
          ...
          <div class="-mr-2 -my-2 md:hidden">
            <button @click="mobileNavOpen=!mobileNavOpen" type="button" class="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" aria-expanded="false">
        ...
        -->
        <div x-show="mobileNavOpen" x-cloak class="absolute z-30 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
          <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
            <div class="pt-5 pb-6 px-5">
              <div class="flex items-center justify-between">
                ...
                <div class="-mr-2">
                  <button @click="mobileNavOpen=false" type="button" class="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
            ...
            <div class="py-6 px-5">
              <div class="grid grid-cols-2 gap-4">
                ...
                <a href="#" class="text-base font-medium text-gray-900 hover:text-gray-700"> Branch </a>
                <a href="#" class="text-base font-medium text-gray-900 hover:text-gray-700"> Account </a>
    ...
    <footer class="bg-gray-700 mt-10">
        <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
          <nav class="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
            <div class="px-5 py-2">
              <a href="#" class="text-base text-white hover:text-gray-900"> About </a>
            </div>
          ...
          <p class="mt-8 text-center text-base text-white">&copy; 2022 J7 IT SOLUTIONS. All rights reserved.</p>
        </div>
      </footer>
  </div>
